$(function(){
    ...
    aryQuiz.push(
        {
            question : '世界人口ランキング第3位の国は？',
            answer : ['アメリカ', 'インド', 'ブラジル', '日本']
        }
        ,{
            question : '世界遺産の数が世界1位の国は？',
            answer : ['イタリア', '日本', 'フランス', '中国']
        }
        ,{
            question : '2018ロシアW杯優勝国は？',
            answer : ['フランス', 'スペイン', 'アメリカ', 'イギリス']
        }
        ,{
            question : 'ブラジルの公用語は？',
            answer : ['ポルトガル語', 'フランス語', '英語', 'スペイン語']
        }
        ,{
            question : '次のうち、国旗が長方形じゃないのは？',
            answer : ['スイス', 'ブラジル', 'ドイツ', 'ギリシャ']
        }
    );
